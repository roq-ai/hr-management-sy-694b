  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Centralize, Streamline, and Elevate. Empowering employees to manage their data, track time, plan vacations. Enabling payroll office to integrate payrolls effortlessly and team leads to evaluate performance efficiently. Your comprehensive solution for all HR needs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Centralize, Streamline, and Elevate. Empowering employees to manage their data, track time, plan vacations. Enabling payroll office to integrate payrolls effortlessly and team leads to evaluate performance efficiently. Your comprehensive solution for all HR needs.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Employee" type="employee" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
