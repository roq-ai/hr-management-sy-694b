...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Product #67890.create': { roles: ['tenant-roles'], key: 'product', tenantPath: [], userPath: [] },
  'Product #67890.update': { roles: ['tenant-roles'], key: 'product', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['employee'];
